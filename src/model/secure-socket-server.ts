...
import { RxSocket, RxSocketServer, SecureSocket, SocketAuthenticator, SocketRoom } from './';

export class SecureSocketServer implements RxSocketServer {
  constructor(private _authenticator: SocketAuthenticator, private _server: Server) {}
